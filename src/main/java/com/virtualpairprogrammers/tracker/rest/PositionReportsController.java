...
public class PositionReportsController 
{
	...
	public Collection<VehiclePosition> getUpdatedPositions(@RequestParam(value="since", required=false) String since)
	{
		//System.out.println("Inside REST getUpdatedPositions method, since:" + since);
		...
		//System.out.println("Inside REST getUpdatedPositions method, sinceDate:" + sinceDate);

		return data.getLatestPositionsOfAllVehiclesUpdatedSince(sinceDate);
	}
}
